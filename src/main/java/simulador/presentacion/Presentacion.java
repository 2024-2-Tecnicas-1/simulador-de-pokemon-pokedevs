...
import simulador.aplicacion.Batalla;
        ...
        while (continuar) {
            ...
            switch (opcion) {
                case 1:  // Entrenar Pokémon
                    ...
                    break;
                case 2:  // Añadir Pokémon
                    if (entrenador.getPokemones().size() < 10) { // Verifica si hay espacio en el equipo
                        Pokemon nuevoPokemon = primerPokemon(); // Genera un Pokémon aleatorio
                        entrenador.agregarPokemon(nuevoPokemon); // Añade el Pokémon al equipo
                        System.out.println("¡Un nuevo Pokémon ha sido añadido a tu equipo!");
                    } else {
                        System.out.println("No puedes añadir más Pokémon, tu equipo ya está completo.");
                    }
                    break;
                ...
                case 4:  // Iniciar batalla
                    ...
                    entrenador.mostrarPokemones();
                    System.out.println("Que pokemon quieres escoger:");
                    int index = scanner.nextInt();
                    index -= 1;
                    Batalla batallita = new Batalla(entrenador.prepararBatalla(index));
                    batallita.iniciarBatalla(scanner);
